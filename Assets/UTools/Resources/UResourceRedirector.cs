...
/// </summary>
public class UResoruceRedirector : MonoBehaviour
{
    /// <summary>
    ...
    /// </summary>
    public UResourceIndex Index;

    // Start is called before the first frame update
    void Start()
    {
        //Redirection depends of the current application mode
        ApplicationMode Mode = UResourceManager.Instance.AppMode;
        switch (Mode)
        {
    ...
    void PerformPreviewRedirection()
    {
        ...
        if (Index.FindResourceScene(UResourceManager.Instance.PreviewResourceCode, out RedirectPath))
        {
