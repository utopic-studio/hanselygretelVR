...
/// </summary>
public class UResourceIndex : MonoBehaviour
{
    /// <summary>
    ...
    private class ResourceBaker : UnityEngine.Object
    {
        ...
        void OnBakeLevelOpened(Scene scene, OpenSceneMode mode)
        {
            ...
            {
                List<UResource> Resources = new List<UResource>();
                go.GetComponentsInChildren<UResource>(true, Resources);
        ...
        void OnFinishBakeLevelOpened(Scene scene, OpenSceneMode mode)
        {
            ...
            UResourceIndex Index = Caller != null ? Caller.GetComponentInChildren<UResourceIndex>() : null;
            if(Index)
            {
