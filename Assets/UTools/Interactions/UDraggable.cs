...
/// </summary>
[AddComponentMenu("UTools/Interactions/UDraggable")]
public class UDraggable : MonoBehaviour
{
    ...
    /// </summary>
    private static UDraggable CurrentDragOperation = null;

    /// <summary>
    /// Original transform struct, used to undo the movement if canceled.
    /// </summary>
    private UTrans OriginalTransform;
    ...
    public void BeginDragOperation()
    {
        if (IsDraggable && CurrentDragOperation == null)
        {
            ...
            OriginalTransform = new UTrans(gameObject.transform);
